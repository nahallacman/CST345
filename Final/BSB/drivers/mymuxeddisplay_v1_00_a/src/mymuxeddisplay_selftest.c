/*****************************************************************************
* Filename:          C:\Users\mainuser\Desktop\School\CST345\Final\BSB/drivers/mymuxeddisplay_v1_00_a/src/mymuxeddisplay_selftest.c
* Version:           1.00.a
...
XStatus MYMUXEDDISPLAY_SelfTest(void * baseaddr_p)
{
  ...
  MYMUXEDDISPLAY_mWriteSlaveReg5(baseaddr, 0, 6);
  Reg32Value = MYMUXEDDISPLAY_mReadSlaveReg5(baseaddr, 0);
  ...
  MYMUXEDDISPLAY_mWriteSlaveReg6(baseaddr, 0, 7);
  Reg32Value = MYMUXEDDISPLAY_mReadSlaveReg6(baseaddr, 0);
