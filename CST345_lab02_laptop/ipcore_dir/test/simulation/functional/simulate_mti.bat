...
vlog -work work ..\..\..\test.v
vlog -work work ..\..\example_design\test_exdes.v
vlog -work work ..\test_tb.v

REM run the simulation
vsim -c -t ps -voptargs="+acc" -L secureip -L unisims_ver work.test_tb work.glbl
