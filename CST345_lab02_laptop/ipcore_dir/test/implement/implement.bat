...
ngdbuild -uc test_exdes.ucf test_exdes

echo 'Running map'
map -timing -pr b test_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm test_exdes -w routed.ncd routed.v
cd ..
