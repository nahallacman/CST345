/*****************************************************************************
* Filename:          C:\Users\mainuser\Desktop\School\CST345\FinalTry3\BSB/drivers/mykeyboard_v1_00_a/src/mykeyboard_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the mykeyboard driver
...
XStatus MYKEYBOARD_SelfTest(void * baseaddr_p)
{
  ...
  MYKEYBOARD_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MYKEYBOARD_mReadSlaveReg0(baseaddr, 0);
