/*****************************************************************************
* Filename:          C:\Users\mainuser\Desktop\School\CST345\FinalTry3\BSB/drivers/mydemoleds_v1_00_a/src/mydemoleds_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the mydemoleds driver
...
XStatus MYDEMOLEDS_SelfTest(void * baseaddr_p)
{
  ...
  MYDEMOLEDS_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MYDEMOLEDS_mReadSlaveReg0(baseaddr, 0);
  ...
  MYDEMOLEDS_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MYDEMOLEDS_mReadSlaveReg1(baseaddr, 0);
