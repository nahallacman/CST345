/*****************************************************************************
* Filename:          C:\Users\mainuser\Desktop\School\CST345\FinalTry3\BSB/drivers/mymuxeddisplay_v1_00_a/src/mymuxeddisplay_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the mymuxeddisplay driver
...
XStatus MYMUXEDDISPLAY_SelfTest(void * baseaddr_p)
{
  ...
  MYMUXEDDISPLAY_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MYMUXEDDISPLAY_mReadSlaveReg0(baseaddr, 0);
  ...
  MYMUXEDDISPLAY_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MYMUXEDDISPLAY_mReadSlaveReg1(baseaddr, 0);
  ...
  MYMUXEDDISPLAY_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = MYMUXEDDISPLAY_mReadSlaveReg2(baseaddr, 0);
  ...
  MYMUXEDDISPLAY_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = MYMUXEDDISPLAY_mReadSlaveReg3(baseaddr, 0);
  ...
  MYMUXEDDISPLAY_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = MYMUXEDDISPLAY_mReadSlaveReg4(baseaddr, 0);
