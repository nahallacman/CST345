...
Peripheral Summary:
  ...
  logical library name                       : mydemoleds_v1_00_a
  top name                                   : mydemoleds
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/mydemoleds_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/mydemoleds_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/mydemoleds_v2_1_0.tcl
