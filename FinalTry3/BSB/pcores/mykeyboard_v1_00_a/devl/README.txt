...
Peripheral Summary:
  ...
  logical library name                       : mykeyboard_v1_00_a
  top name                                   : mykeyboard
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/mykeyboard_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/mykeyboard_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/mykeyboard_v2_1_0.tcl
